...
public class SlidersController : ControllerBase
{
    ...
    {
        var items = await _db.SliderImages
            .Where(s => s.IsActive)
    ...
    [HttpPost]
    public async Task<IActionResult> Create([FromForm] SliderDto dto)
    {
    ...
    [HttpPut("{id:guid}")]
    public async Task<IActionResult> Update(Guid id, [FromForm] SliderDto dto)
    {
