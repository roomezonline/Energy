...
public class NewsController : ControllerBase
{
    ...
    {
        var items = await _db.NewsArticles.OrderBy(n => n.SortOrder).ThenByDescending(n => n.CreatedAt).ToListAsync();
        return Ok(items);
    }
    ...
    [HttpPost]
    public async Task<IActionResult> Create([FromForm] V2NewsArticleDto dto)
    {
    ...
    [HttpPut("{id:guid}")]
    public async Task<IActionResult> Update(Guid id, [FromForm] V2NewsArticleDto dto)
    {
